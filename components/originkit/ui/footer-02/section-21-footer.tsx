...
export function Section21Footer() {
  return (
    <section
      ...
      className="relative isolate flex min-h-svh w-full flex-col items-center justify-end overflow-hidden bg-[var(--color-bg)] pb-10 pt-16 ipad:pt-24 desktop-sm:pt-32"
    >
