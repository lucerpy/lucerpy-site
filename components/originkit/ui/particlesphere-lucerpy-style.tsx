// Originkit preset `lucerpy-style` — props baked into the default export.
"use client"
...
export default function ParticleSphereRefactor(props: Record<string, unknown>) {
  return <__OriginkitBase_ParticleSphereRefactor {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
